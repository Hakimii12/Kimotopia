...
import {followUnfollow, GetAllUser, getUser, getUserId, login, logout, signUp, update} from '../controllers/UserActivities.js'
...
router.get('/allprofile',Authorization, GetAllUser)
